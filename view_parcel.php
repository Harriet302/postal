...
$branch = array();
 $branches = $conn->query("SELECT *,concat(street,', ',contact) as address FROM branches where id in ($to_branch_id,$from_branch_id)");
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="callout callout-info">
					...
					<dl>
						<dt>PickUp Station Accepted the Parcel:</dt>
						<dd><?php echo ucwords($branch[$from_branch_id]) ?></dd>
						<?php if($type == 2): ?>
							<dt>Nearest Point to Recipient for Pickup:</dt>
						...
						<dd>
							...
							switch ($status) {
								case '0':
									echo "<span class='badge badge-pill badge-success'> Item Accepted by Client</span>";
									break;
								case '1':
									echo "<span class='badge badge-pill badge-primary'> Out for Delivery</span>";
									break;
								case '2':
									echo "<span class='badge badge-pill badge-success'> Arrived At Destination</span>";
									break;
								case '3':
									echo "<span class='badge badge-pill badge-info'> Picked up</span>";
									break;
								case '4':
									echo "<span class='badge badge-pill badge-'> Unsuccessful Delivery Attempt</span>";
									break;
