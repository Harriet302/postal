          ...
          <div class="col-md-12">
            ...
            <div class="row">
              ...
              <div class="col-sm-6 form-group ">
                ...
                <input type="text" name="address" id="" class="form-control form-control-sm" value="<?php echo isset($address) ? $address : '' ?>" required>
              </div>

              <div class="col-sm-6 form-group ">
                <label for="" class="control-label">Phone</label>
                <input type="text" name="phone" id="" class="form-control form-control-sm" value="<?php echo isset($phone) ? $phone : '' ?>" required>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-sm-6 form-group ">
                ...
                <select name="branch_id" id="" class="form-control input-sm select2">
                  ...
                  ?>
                  <option value="<?php echo $row['id'] ?>" <?php echo isset($branch_id) && $branch_id == $row['id'] ? "selected":'' ?>><?php echo $row['station_name']. ' | '.(ucwords($row['address'])) ?></option>
                <?php endwhile; ?>
                </select>
              </div>
            </div>
