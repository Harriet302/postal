...
Class Action {
	...
	function get_parcel_heistory(){
		...
		if($parcel->num_rows <=0){
			...
			$status_arr = array("Item Accepted by Client","Arrived At Destination","Out for Delivery","Ready to Pickup","Delivered","Picked-up","Unsuccessfull Delivery Attempt");
	...
	function get_report(){
		...
		$status_arr = array("Item Accepted by Courier","Arrived At Destination","Out for Delivery","Ready to Pickup","Delivered","Picked-up","Unsuccessfull Delivery Attempt");
